...
r1=('id_1|taxon_1', 'marker_1', 'query_id', 1.0, 0.141026)
r2=('taxon_2', 'marker_2', 'second_query_id', 0.973511, 0.02327)
r3=('taxon_2', 'marker_3', 'third_query_id', 0.973511, 0.074)
r4=('taxon_2', 'marker_3', 'fourth_query_id', 0.973511, 0.074)
r5=('taxon_3', 'marker_1', 'fifth_query_id', 1.0, 0.02)
...
class ReadAlignments(unittest.TestCase):
    ...
    def test_filter_match_identity(self):
        sam = pysam.AlignmentFile(dir_path + "/data/example.sam")
        alignment_store = read_alignments(sam, None, pattern_taxon, pattern_marker, marker_to_taxon_id,  min_mapq = 0, min_query_length = 0, min_match_identity = 0.99 )
        content = [t for t in alignment_store.query('select * from alignment')]
