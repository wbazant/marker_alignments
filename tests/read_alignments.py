...
class ReadAlignments(unittest.TestCase):
    ...
    def test_example(self):
        ...
        self.assertEqual(content, [('id_1:taxon_1', 'marker_1', 'query_id', 1.0, 0.141026), ('taxon_2', 'marker_2', 'second_query_id', 0.973511, 0.02327), ('taxon_2', 'marker_3', 'third_query_id', 0.973511, 0.074),  ('taxon_2', 'marker_3', 'fourth_query_id', 0.973511, 0.074)])
