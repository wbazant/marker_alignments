...
# bundle GuyAllard's markov_clustering
# all credit to them except for the startup warning I don't want
# below version is 0.0.4
...
def clusters(triples):
    ...
    for l1, l2, value in triples:
        matrix[d[l1], d[l2]] = value
